...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Category_id = new Property(1, Integer.class, "category_id", false, "CATEGORY_ID");
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // category_id
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setCategory_id(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
